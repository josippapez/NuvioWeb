...
import {
  buildHeroDisplayModel as createHeroDisplayModel,
  buildHeroIdentity as createHeroIdentity,
  buildHeroIndicators,
  renderHeroMarkup as createHeroMarkup,
...
function buildHeroIdentity(item = null) {
  return createHeroIdentity(item, { normalizeCatalogItem });
}

function buildHeroDisplayModel(hero, layoutMode) {
  return createHeroDisplayModel(hero, layoutMode, {
    firstNonEmpty,
...
function renderMetaTokens(tokens = []) {
  return createMetaTokens(tokens, escapeHtml);
}

function renderHeroMarkup(layoutMode, heroItem, heroCandidates) {
  return createHeroMarkup(layoutMode, heroItem, heroCandidates, {
